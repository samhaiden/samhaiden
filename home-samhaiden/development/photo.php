    ...
    <!-- <?php include("include/menu.php");?> -->
        ...
        <section id="hero">
            ...
            <div id="inner-hero">
                ...
                <h1 class="main-header">Photography</h1>

                <a class="btn-learnmore" href="#gallery">Gallery</a>
        ...
        <section class="photo">
            ...
            <div class="photo-title section-title">

                            <a name="gallery" id="gallery" class="anchor-offset"></a>
            ...
            <div id="gallery-container">
                ...
                <div class="image-holder image-1 portrait"></div> 
                
                <div class="image-holder image-2 landscape"></div> 
                
                <div class="image-holder image-3 portrait"></div> 
                
                <div class="image-holder image-4 landscape"></div> 
                
                <div class="image-holder image-5 landscape"></div> 
                
                <div class="image-holder image-6 portrait"></div> 
