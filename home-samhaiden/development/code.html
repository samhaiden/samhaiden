    ...
    <!-- <?php include("include/menu.php");?> -->
        ...
        <section id="hero">
            ...
            <div id="inner-hero">
                ...
                <h1 class="main-header">Code</h1>

                <a class="btn-learnmore" href="#projects">Learn More</a>
        ...
        <div class="col-one row-one" id="one">
            ...
            <a class="one" href="https://www.samhaiden.com/projects/guessing-game1/index.html">
        ...
        <div class="col-two row-one" id="two">
            ...
            <a class="two" href="https://www.samhaiden.com/projects/weather-scraper.php">
        ...
        <div class="col-three row-one" id="three">
            ...
            <a class="three" href="https://www.samhaiden.com/projects/clock.php">
        ...
        <div class="col-one row-two" id="four">
            ...
            <a class="four" href="https://www.samhaiden.com/projects/twitter-feed.php">
        ...
        <div class="col-two row-two" id="five">
            ...
            <a class="five" href="https://www.samhaiden.com/projects/reaction-test/reaction-test.php">

                <i class="fas fa-stopwatch"></i>

                <h2 class="title">Reaction</h2>
        ...
        <div class="col-three row-two" id="six">
            ...
            <a class="six" href="https://www.samhaiden.com/projects/mastermind.php">

                <i class="fas fa-chess-knight"></i>

                <h2 class="title">Mastermind</h2>
